...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<s:iterator value="newList">
									<li>
										<a  target="_blank" href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="pid" />"><img src="${pageContext.request.contextPath}/<s:property value="image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/b499fb5e-999f-431b-a375-172ee09e4a3e-thumbnail.jpg" style="display: block;" /></a>
									</li>
							</s:iterator>
						</ul>
						<ul class="tabContent" style="display: none;">
